...
function Home() {
  return (
    <Container>
      ...
      <div subheading="Home ml-2" className="home-div">
        <img
          src={home}
          alt="Home"
      ...
      <div className="px-3 m-3 objects">
        ...
        <br></br>
        <p>
          Thrive on developing new Apps and really challenging myself to try new
          things. Please navigate into the Projects section to view projects
          with deployed link and github provided. For more information about me
          you can click the social icons at the bottom of the page or navigate
          to the Contact page!
        </p>
      </div>
      </div>
